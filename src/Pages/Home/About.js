         ...
         <div class="flex bg-base-100 flex-col  w-full lg:flex-row">
            <div class="grid flex-grow  card">
                <span className='border-cyan-900'>
                    ...
                    <p class="py-6 font-bold leading-loose  text-violet-50 text-start">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
                </span>
            </div>
