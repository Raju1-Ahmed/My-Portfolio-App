...
const Skills = () => {
  ...
  return (
    <div id='skill' class="container mx-auto mt-[100px]">
            <h2 className='text-5xl text-left text-gray-800 dark:text-gray-100 font-bold'>Mentioned below are the skills I excel at</h2>
